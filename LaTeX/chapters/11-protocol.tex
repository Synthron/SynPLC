...
&	byte 5:& 	data (only send when writing 16bit register) \\
&	byte 6:& 	Checksum \\
&&	\\
&	byte 7:& 	Answer from slave (ACK or (NACK with Errorcode)) \\
&	byte 8:& 	Answer from slave (data, 8bit read or MSB when 16bit read) \\
&	byte 9:& 	Answer from slave (data, LSB when 16bit read) \\
...
\begin{table}[H]
    \centering
        \begin{tabular}{|c|c|}
            ...
            0100 xxxx   & Lese Fehler-Register \\ \hline
